...
const SPECS = [
  { label: "Machine", value: "Portfolio Workstation" },
  { label: "Focus", value: "Backend & Systems" },
  { label: "Owner", value: "Dung Dương" },
  { label: "Interface", value: "macOS web shell" },
];
        ...
        <>
          ...
          >
            ...
            <div style={{ textAlign: "center", padding: "0 16px 14px", fontSize: 10, color: "rgba(0,0,0,0.35)", lineHeight: 1.5 }}>
              <div>Dung Dương</div>
              <div>Built for recruiters, engineers, and curious technical readers.</div>
            </div>
          </motion.div>
        </>
      )}
