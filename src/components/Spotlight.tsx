...
const AppIcon = ({ app, sizeClass }: { app: any; sizeClass: string }) => {
  ...
  if (isPortfolio) {
    return (
      <div className={`${sizeClass} rounded-[22.5%] shadow-sm overflow-hidden flex items-center justify-center border border-black/10 dark:border-white/10 relative bg-white`}>
