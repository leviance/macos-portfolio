  ...
  return (
    <div>
      ...
      <Card>
        ...
        <Row label="Region">
          <span style={{ fontSize: "12px", color: dark ? "rgba(255,255,255,0.5)" : "rgba(0,0,0,0.5)" }}>Vietnam</span>
        </Row>
      </Card>
      <SectionTitle>Sharing</SectionTitle>
      <Card>
        <Row label="Computer Name">
          <span style={{ fontSize: "12px", color: dark ? "rgba(255,255,255,0.5)" : "rgba(0,0,0,0.5)" }}>Dung's Portfolio Mac</span>
        </Row>
      </Card>
    </div>
  );
...
const SoundPanel = () => {
  ...
  const alertSounds = [
    ...
    { label: "Portfolio Intro", value: "music/akashintro.wav" },
  ];
  ...
  return (
    <div>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "24px 16px 16px", gap: "8px" }}>
        ...
        <div style={{ fontSize: "22px", fontWeight: 700, color: dark ? "#fff" : "#1c1c1e", marginTop: "8px" }}>macOS Ventura</div>
        <div style={{ fontSize: "13px", color: dark ? "rgba(255,255,255,0.5)" : "rgba(0,0,0,0.5)" }}>Version 13.0 (Portfolio Edition)</div>
      </div>
      <Card>
        {[
        ...
        <div style={{ flex: 1, paddingBottom: isMobile ? "20px" : "0" }}>
          {isMobile && !search.trim() && (
            ...
            >
              ...
              <div>
                <div style={{ fontSize: "20px", fontWeight: 400, color: dark ? "#fff" : "#000", letterSpacing: "-0.5px" }}>Dung Dương</div>
