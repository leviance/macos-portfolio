...
const PHOTOS: Photo[] = [
  { id: "profile", url: "/img/ui/avatar.jpg", label: "Dung Dương", date: "Profile", albums: ["profile"], liked: true },
  { id: "milan", url: "/img/icons/photos.png", label: "Milan Player", date: "Multimedia case study", albums: ["case", "research"], liked: true },
...
const ALBUMS = [
  ...
  { id: "favorites", label: "Favourites", icon: "i-ph:heart-fill", count: PHOTOS.filter((photo) => photo.liked).length },
  { id: "research", label: "Research", icon: "i-ph:tree-structure", count: PHOTOS.filter((photo) => photo.albums.includes("research")).length },
  { id: "case", label: "Case Studies", icon: "i-ph:laptop", count: PHOTOS.filter((photo) => photo.albums.includes("case")).length },
  { id: "public", label: "Public Repos", icon: "i-ph:code", count: PHOTOS.filter((photo) => photo.albums.includes("public")).length },
];
...
export default function Photos() {
  ...
  const displayed =
    activeAlbum === "favorites"
      ...
      : activeAlbum === "recents"
        ? photos
        : photos.filter((p) => p.albums.includes(activeAlbum));
    ...
    >
      ...
      <div className="mobile-only mobile-tab-bar">
        ...
        <div 
          ...
          onClick={() => { if (window.innerWidth <= 768) setActiveAlbum("case"); }}
        >
