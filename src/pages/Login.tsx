...
const FULLSCREEN_SETTLE_DELAY_MS = 520;

const waitForFullscreenSettle = (): Promise<void> =>
  new Promise((resolve) => {
    window.setTimeout(resolve, FULLSCREEN_SETTLE_DELAY_MS);
  });
...
export default function Login(props: MacActions) {
  ...
  const keyPress = (e: React.KeyboardEvent) => {
    const keyCode = e.key;
    if (keyCode === "Enter" || keyCode === " " || keyCode === "Space" || keyCode === "Tab") {
      e.preventDefault();
      void signIn();
    }
  };
