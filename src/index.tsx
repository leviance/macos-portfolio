...
// macOS desktop transition variants
...
> {
  ...
  render() {
    if (this.state.error) {
      return (
        <div style={{ minHeight: "100vh", display: "grid", placeItems: "center", background: "#101014", color: "white", fontFamily: "system-ui, sans-serif", padding: 24 }}>
          <div style={{ maxWidth: 720, border: "1px solid rgba(255,255,255,.16)", borderRadius: 14, padding: 24, background: "rgba(255,255,255,.08)" }}>
            <h1 style={{ margin: "0 0 10px", fontSize: 22 }}>Portfolio runtime error</h1>
            <pre style={{ whiteSpace: "pre-wrap", fontSize: 13, lineHeight: 1.6, color: "rgba(255,255,255,.82)" }}>
